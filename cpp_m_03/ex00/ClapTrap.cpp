...
/*   Updated: 2025/06/07 10:57:48 by hthant           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage(unsigned int amount){
    ...
    std::cout << "ClapTrap " << this->_name << " takes " << this->_name << " points of damage!" << std::endl;
    if(this->_hitPoint <= 0)
    {
        std::cout << "ClapTrap " << this->_name << "is dead." << std::endl;
        this->_hitPoint = 0;
    }
    std::cout<< "Hit point before: " << oldhitpoint << " HP." << std::endl;
    std::cout<<" hit point after Damage: " << this->_hitPoint << " HP." << std::endl;
}
